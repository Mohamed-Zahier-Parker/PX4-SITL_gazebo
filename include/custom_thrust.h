...
class Customthrust : public MotorModel, public ModelPlugin {
 public:
  Customthrust()
      : ModelPlugin(),
        MotorModel(),
 ...
 protected:int thrust_command=0;
